...
namespace Quiz
{
    public partial class Dinnerev : Form
    {
        public Dinnerev()
        {
            InitializeComponent();
        ...
        private void btn_dinnerev_why_Click(object sender, EventArgs e)
        {
            foreach (var item in lb_dinnerev.SelectedItems)
            {
        ...
        private void btn_dinnerev_exit_Click(object sender, EventArgs e)
        {
