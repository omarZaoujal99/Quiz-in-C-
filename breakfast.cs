...
namespace Quiz
{
    public partial class breakfast : Form
    {
        ...
        {
            foreach (var item in lb_efd_glad.SelectedItems)
            {
                if (item.ToString() == "Starches")
                {
                ...
                else if(item.ToString() == "Chocolates")
                {
        ...
        private void btn_efd_glad_exit_Click(object sender, EventArgs e)
        {
